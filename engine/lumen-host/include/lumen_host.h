...
typedef enum LumenHostPlatformVideoProfile {
  ...
  LumenHostPlatformVideoProfileShadowVCRegionalPredictor8 = 9,
  LumenHostPlatformVideoProfileShadowVCLuma16 = 10,
...
typedef enum LumenHostPlatformRuntimeEventCode {
  ...
  LumenHostPlatformRuntimeEventCodeNativeVideoAdaptiveControl = 16,
