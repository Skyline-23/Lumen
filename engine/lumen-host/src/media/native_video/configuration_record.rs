...
fn validate_avcc_header(
    ...
    let expected_profile = match format.profile {
        ...
        | PlatformVideoProfile::Av1Main | PlatformVideoProfile::ShadowVcSpatialBase16 | PlatformVideoProfile::ShadowVcRegionalPredictor8 | PlatformVideoProfile::ShadowVcLuma16 => {
            return Err(
...
impl HevcConfigurationHeader {
    ...
    fn matches_selected(self, format: PlatformVideoFormat) -> bool {
        let profile_idc = match format.profile {
            ...
            | PlatformVideoProfile::Av1Main | PlatformVideoProfile::ShadowVcSpatialBase16 | PlatformVideoProfile::ShadowVcRegionalPredictor8 | PlatformVideoProfile::ShadowVcLuma16 => return false,
        };
