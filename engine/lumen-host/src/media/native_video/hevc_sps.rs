...
pub(super) fn parse_and_validate_hevc_sps(
    ...
    let selected_profile_matches = match expected.profile {
        ...
        | PlatformVideoProfile::Av1Main | PlatformVideoProfile::ShadowVcSpatialBase16 | PlatformVideoProfile::ShadowVcRegionalPredictor8 | PlatformVideoProfile::ShadowVcLuma16 | PlatformVideoProfile::ShadowVcPixel10 => false,
    };
