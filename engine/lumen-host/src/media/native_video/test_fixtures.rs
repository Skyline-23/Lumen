...
fn avc_sps(format: PlatformVideoFormat) -> Vec<u8> {
    let profile_idc = match format.profile {
        ...
        | PlatformVideoProfile::Av1Main | PlatformVideoProfile::ShadowVcSpatialBase16 | PlatformVideoProfile::ShadowVcRegionalPredictor8 | PlatformVideoProfile::ShadowVcLuma16 => 0,
    };
