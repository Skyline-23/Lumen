...
pub trait PlatformSessionControl: Send + Sync {
    ...
    /// Drops encoded audio/video admitted before a media park/resume boundary.
    ///
    /// Capture and encode workers are intentionally allowed to keep running
    /// while the host is parked; this seam only fences the platform-owned
    ...
    fn from(plan: PlatformSessionPlan) -> Self {
        Self {
            ...
            video_profile: match plan.video_format.profile {
                ...
                PlatformVideoProfile::ShadowVcPixel10 => LumenHostPlatformVideoProfile::ShadowVcPixel10,
            },
