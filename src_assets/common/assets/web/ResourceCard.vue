<template>
    <div class="card p-2 mt-4">
        <div class="card-body">
            ...
            <div class="card-group p-4 align-items-center">
                ...
                <a class="btn btn-secondary m-1" href="https://github.com/Skyline-23/Lumen/discussions" target="_blank">
                    <i class="fab fa-fw fa-github"></i> {{ $t('resource_card.github_discussions') }}</a>
                <a class="btn btn-secondary m-1" href="https://github.com/Skyline-23/Lumen/wiki" target="_blank">
                    <i class="fab fa-fw fa-github"></i> {{ $t('resource_card.github_wiki') }}</a>
                <a class="btn btn-secondary m-1" href="https://github.com/Skyline-23/Lumen/wiki/Stuttering-Clinic" target="_blank">
    ...
    <div class="card p-2 mt-4">
        <div class="card-body">
            ...
            <div class="card-group p-4 align-items-center">
                <a class="btn btn-danger m-1" href="https://github.com/Skyline-23/Lumen/blob/master/LICENSE"
                    target="_blank">
                    <i class="fas fa-fw fa-file-alt"></i> {{ $t('resource_card.license') }}</a>
                <a class="btn btn-danger m-1" href="https://github.com/Skyline-23/Lumen/blob/master/NOTICE"
                    target="_blank">
