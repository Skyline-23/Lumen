...
- Ordered-output branch: receiver-side temporal arbitration is now preferred over sender-side paired emission. The next useful version should count or implement bounded hold/drop of composite presentation without delaying encoded tile delivery from MacDisplayKit.
