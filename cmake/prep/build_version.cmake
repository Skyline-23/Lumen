...
if((DEFINED ENV{BRANCH}) AND (DEFINED ENV{BUILD_VERSION}))  # cmake-lint: disable=W0106
    ...
    # Generate Lumen Version based of the git tag
...
list(APPEND LUMEN_DEFINITIONS PROJECT_NAME="${PROJECT_NAME}")
list(APPEND LUMEN_DEFINITIONS PROJECT_VERSION="${PROJECT_VERSION}")
list(APPEND LUMEN_DEFINITIONS PROJECT_VERSION_MAJOR="${PROJECT_VERSION_MAJOR}")
list(APPEND LUMEN_DEFINITIONS PROJECT_VERSION_MINOR="${PROJECT_VERSION_MINOR}")
list(APPEND LUMEN_DEFINITIONS PROJECT_VERSION_PATCH="${PROJECT_VERSION_PATCH}")
list(APPEND LUMEN_DEFINITIONS PROJECT_VERSION_COMMIT="${GITHUB_COMMIT}")
