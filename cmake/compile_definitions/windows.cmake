...
set_target_properties(lumen_rc_object PROPERTIES
    COMPILE_DEFINITIONS "PROJECT_NAME=${PROJECT_NAME};PROJECT_VENDOR=${LUMEN_PUBLISHER_NAME};PROJECT_VERSION_MAJOR=${PROJECT_VERSION_MAJOR};PROJECT_VERSION_MINOR=${PROJECT_VERSION_MINOR};PROJECT_VERSION_PATCH=${PROJECT_VERSION_PATCH}"  # cmake-lint: disable=C0301
    INCLUDE_DIRECTORIES ""
)
