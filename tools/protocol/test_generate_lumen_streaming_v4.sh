...
cp "$root/tools/protocol/generate_lumen_streaming_v4.sh" "$scratch/tools/protocol/"
cp "$root/docs/protocol/lumen-streaming-v4.proto" "$scratch/docs/protocol/"
cp "$scratch/docs/protocol/lumen-streaming-v4.proto" "$scratch/original.proto"
...
for fault in descriptor schema_digest rust_provenance; do
    ...
    cp "$scratch/original.proto" "$scratch/docs/protocol/lumen-streaming-v4.proto"
