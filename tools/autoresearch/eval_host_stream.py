...
def parse_runtime_probe_output(output: str) -> dict[str, Any] | None:
    ...
    optional_int_metrics = {
        ...
        "VT_OUTPUT_CALLBACK_LATENCY_SAMPLE_COUNT": "vt_output_callback_latency_sample_count",
    ...
    optional_float_metrics = {
        ...
        "VT_ENCODE_QUEUE_WAIT_P50_MS": "vt_encode_queue_wait_p50_ms",
        "VT_ENCODE_QUEUE_WAIT_P95_MS": "vt_encode_queue_wait_p95_ms",
        "VT_ENCODE_QUEUE_WAIT_P99_MS": "vt_encode_queue_wait_p99_ms",
        "VT_ENCODE_QUEUE_WAIT_MAX_MS": "vt_encode_queue_wait_max_ms",
        "VT_ENCODE_INVOCATION_AVG_MS": "vt_encode_invocation_avg_ms",
        "VT_ENCODE_INVOCATION_P50_MS": "vt_encode_invocation_p50_ms",
        "VT_ENCODE_INVOCATION_P95_MS": "vt_encode_invocation_p95_ms",
        "VT_ENCODE_INVOCATION_P99_MS": "vt_encode_invocation_p99_ms",
        "VT_ENCODE_INVOCATION_MAX_MS": "vt_encode_invocation_max_ms",
        "VT_METAL_STAGE_AVG_MS": "vt_metal_stage_avg_ms",
        "VT_METAL_STAGE_P50_MS": "vt_metal_stage_p50_ms",
        "VT_METAL_STAGE_P95_MS": "vt_metal_stage_p95_ms",
        "VT_METAL_STAGE_P99_MS": "vt_metal_stage_p99_ms",
        "VT_METAL_STAGE_MAX_MS": "vt_metal_stage_max_ms",
        "VT_ENCODE_CALL_AVG_MS": "vt_encode_call_avg_ms",
        "VT_ENCODE_CALL_P50_MS": "vt_encode_call_p50_ms",
        "VT_ENCODE_CALL_P95_MS": "vt_encode_call_p95_ms",
        "VT_ENCODE_CALL_P99_MS": "vt_encode_call_p99_ms",
        "VT_ENCODE_CALL_MAX_MS": "vt_encode_call_max_ms",
        "VT_OUTPUT_CALLBACK_LATENCY_AVG_MS": "vt_output_callback_latency_avg_ms",
        "VT_OUTPUT_CALLBACK_LATENCY_P50_MS": "vt_output_callback_latency_p50_ms",
        "VT_OUTPUT_CALLBACK_LATENCY_P95_MS": "vt_output_callback_latency_p95_ms",
        "VT_OUTPUT_CALLBACK_LATENCY_P99_MS": "vt_output_callback_latency_p99_ms",
        "VT_OUTPUT_CALLBACK_LATENCY_MAX_MS": "vt_output_callback_latency_max_ms",
    }
