...
def parse_runtime_probe_output(output: str) -> dict[str, Any] | None:
    ...
    optional_int_metrics = {
        ...
        "TILE_FRESH_COMPOSITE_WITHIN_THREE_FRAME_BUDGET": "tile_fresh_composite_within_three_frame_budget",
        "TILE_FRESH_COMPOSITE_WITHIN_FOUR_FRAME_BUDGET": "tile_fresh_composite_within_four_frame_budget",
        "TILE_FRESH_COMPOSITE_OVER_FOUR_FRAME_BUDGET": "tile_fresh_composite_over_four_frame_budget",
        "TILE_FRESH_COMPOSITE_EQUAL_AGE_UPDATES": "tile_fresh_composite_equal_age_updates",
        "TILE_FRESH_COMPOSITE_OLDER_TILE0": "tile_fresh_composite_older_tile0",
        "TILE_FRESH_COMPOSITE_OLDER_TILE1": "tile_fresh_composite_older_tile1",
