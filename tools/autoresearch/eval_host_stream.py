...
def parse_runtime_probe_output(output: str) -> dict[str, Any] | None:
    ...
    optional_int_metrics = {
        ...
        "TILE_NEAREST_PHASE_ONE_FRAME_PAIRS": "tile_nearest_phase_one_frame_pairs",
        "TILE_NEAREST_PHASE_TWO_FRAME_PAIRS": "tile_nearest_phase_two_frame_pairs",
        "TILE_NEAREST_PHASE_THREE_FRAME_PAIRS": "tile_nearest_phase_three_frame_pairs",
        "TILE_NEAREST_PHASE_TWO_FRAME_UPDATES": "tile_nearest_phase_two_frame_updates",
    ...
    optional_float_metrics = {
        ...
        "TILE_NEAREST_PHASE_TWO_FRAME_MAX_SKEW_MS": "tile_nearest_phase_two_frame_max_skew_ms",
    }
