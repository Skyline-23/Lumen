...
def parse_runtime_probe_output(output: str) -> dict[str, Any] | None:
    ...
    metrics: dict[str, Any] = {
        ...
        "saturation_drop_events": as_int("SATURATION_DROP_EVENTS"),
        "core_forwarder_overflow_drop_events": as_int("CORE_FORWARDER_OVERFLOW_DROP_EVENTS"),
        "other_drop_events": as_int("OTHER_DROP_EVENTS"),
