...
def parse_runtime_probe_output(output: str) -> dict[str, Any] | None:
    ...
    optional_int_metrics = {
        ...
        "TILE_PHASE_REPLAY_TWO_FRAME_UPDATES": "tile_phase_replay_two_frame_updates",
        "TILE_PHASE_REPLAY_THREE_FRAME_UPDATES": "tile_phase_replay_three_frame_updates",
        "TILE_PHASE_REPLAY_TWO_FRAME_DROPPED_STALE": "tile_phase_replay_two_frame_dropped_stale",
        "TILE_PHASE_REPLAY_TWO_FRAME_MAX_QUEUE_DEPTH": "tile_phase_replay_two_frame_max_queue_depth",
        "TILE_PHASE_REPLAY_TRACE_DROPPED": "tile_phase_replay_trace_dropped",
    ...
    optional_float_metrics = {
        ...
        "TILE_PHASE_REPLAY_TWO_FRAME_MAX_SKEW_MS": "tile_phase_replay_two_frame_max_skew_ms",
