...
def parse_runtime_probe_output(output: str) -> dict[str, Any] | None:
    ...
    optional_int_metrics = {
        ...
        "TILE_RECEIVER_ARBITRATED_ONE_FRAME_UPDATES": "tile_receiver_arbitrated_one_frame_updates",
        "TILE_RECEIVER_ARBITRATED_TWO_FRAME_UPDATES": "tile_receiver_arbitrated_two_frame_updates",
        "TILE_RECEIVER_ARBITRATED_THREE_FRAME_UPDATES": "tile_receiver_arbitrated_three_frame_updates",
        "TILE_RECEIVER_ARBITRATED_FOUR_FRAME_UPDATES": "tile_receiver_arbitrated_four_frame_updates",
        "TILE_RECEIVER_ARBITRATED_ONE_FRAME_HELD_UPDATES": "tile_receiver_arbitrated_one_frame_held_updates",
        "TILE_RECEIVER_ARBITRATED_TWO_FRAME_HELD_UPDATES": "tile_receiver_arbitrated_two_frame_held_updates",
        "TILE_RECEIVER_ARBITRATED_THREE_FRAME_HELD_UPDATES": "tile_receiver_arbitrated_three_frame_held_updates",
        "TILE_RECEIVER_ARBITRATED_FOUR_FRAME_HELD_UPDATES": "tile_receiver_arbitrated_four_frame_held_updates",
        "TILE_ARRIVAL_TRANSITIONS": "tile_arrival_transitions",
        "TILE_ARRIVAL_SAME_TILE_RUNS": "tile_arrival_same_tile_runs",
        "TILE_ARRIVAL_LONGEST_SAME_TILE_RUN": "tile_arrival_longest_same_tile_run",
    ...
    optional_float_metrics = {
        ...
        "TILE_RECEIVER_ARBITRATED_TWO_FRAME_MAX_SKEW_MS": "tile_receiver_arbitrated_two_frame_max_skew_ms",
    }
