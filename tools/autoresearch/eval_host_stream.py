...
def parse_runtime_probe_output(output: str) -> dict[str, Any] | None:
    ...
    optional_int_metrics = {
        ...
        "STATEFUL_PRESENTATION_ONE_FRAME_UPDATES": "stateful_presentation_one_frame_updates",
        "STATEFUL_PRESENTATION_TWO_FRAME_UPDATES": "stateful_presentation_two_frame_updates",
        "STATEFUL_PRESENTATION_THREE_FRAME_UPDATES": "stateful_presentation_three_frame_updates",
