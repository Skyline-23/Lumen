...
void emitSelectedDiagnostics(const char *diagnostics) {
  ...
  static constexpr DiagnosticEmission emissions[] = {
    ...
    {"videoToolboxTileLane0ProcessedFrameCount", "VT_TILE_LANE0_PROCESSED_FRAME_COUNT"},
    {"videoToolboxTileLane0OutputCallbackCount", "VT_TILE_LANE0_OUTPUT_CALLBACK_COUNT"},
    {"videoToolboxTileLane0CompletedOutputFrameCount", "VT_TILE_LANE0_COMPLETED_OUTPUT_FRAME_COUNT"},
    {"videoToolboxTileLane0StagedSubmissionFrameCount", "VT_TILE_LANE0_STAGED_SUBMISSION_FRAME_COUNT"},
    {"videoToolboxTileLane0SubmittedFrameCount", "VT_TILE_LANE0_SUBMITTED_FRAME_COUNT"},
    {"videoToolboxTileLane0MinOutputCallbackLatencyMilliseconds", "VT_TILE_LANE0_MIN_CALLBACK_LATENCY_MS"},
    {"videoToolboxTileLane0MaxOutputCallbackLatencyMilliseconds", "VT_TILE_LANE0_MAX_CALLBACK_LATENCY_MS"},
    {"videoToolboxTileLane0EncodeQueueWaitAverageMilliseconds", "VT_TILE_LANE0_ENCODE_QUEUE_WAIT_AVG_MS"},
    {"videoToolboxTileLane0EncodeQueueWaitMaxMilliseconds", "VT_TILE_LANE0_ENCODE_QUEUE_WAIT_MAX_MS"},
    {"videoToolboxTileLane0EncodeInvocationAverageMilliseconds", "VT_TILE_LANE0_ENCODE_INVOCATION_AVG_MS"},
    {"videoToolboxTileLane0EncodeInvocationMaxMilliseconds", "VT_TILE_LANE0_ENCODE_INVOCATION_MAX_MS"},
    {"videoToolboxTileLane0MetalStageAverageMilliseconds", "VT_TILE_LANE0_METAL_STAGE_AVG_MS"},
    {"videoToolboxTileLane0MetalStageMaxMilliseconds", "VT_TILE_LANE0_METAL_STAGE_MAX_MS"},
    {"videoToolboxTileLane0VTEncodeCallAverageMilliseconds", "VT_TILE_LANE0_ENCODE_CALL_AVG_MS"},
    {"videoToolboxTileLane0VTEncodeCallMaxMilliseconds", "VT_TILE_LANE0_ENCODE_CALL_MAX_MS"},
    {"videoToolboxTileLane1ProcessedFrameCount", "VT_TILE_LANE1_PROCESSED_FRAME_COUNT"},
    {"videoToolboxTileLane1OutputCallbackCount", "VT_TILE_LANE1_OUTPUT_CALLBACK_COUNT"},
    {"videoToolboxTileLane1CompletedOutputFrameCount", "VT_TILE_LANE1_COMPLETED_OUTPUT_FRAME_COUNT"},
    {"videoToolboxTileLane1StagedSubmissionFrameCount", "VT_TILE_LANE1_STAGED_SUBMISSION_FRAME_COUNT"},
    {"videoToolboxTileLane1SubmittedFrameCount", "VT_TILE_LANE1_SUBMITTED_FRAME_COUNT"},
    {"videoToolboxTileLane1MinOutputCallbackLatencyMilliseconds", "VT_TILE_LANE1_MIN_CALLBACK_LATENCY_MS"},
    {"videoToolboxTileLane1MaxOutputCallbackLatencyMilliseconds", "VT_TILE_LANE1_MAX_CALLBACK_LATENCY_MS"},
    {"videoToolboxTileLane1EncodeQueueWaitAverageMilliseconds", "VT_TILE_LANE1_ENCODE_QUEUE_WAIT_AVG_MS"},
    {"videoToolboxTileLane1EncodeQueueWaitMaxMilliseconds", "VT_TILE_LANE1_ENCODE_QUEUE_WAIT_MAX_MS"},
    {"videoToolboxTileLane1EncodeInvocationAverageMilliseconds", "VT_TILE_LANE1_ENCODE_INVOCATION_AVG_MS"},
    {"videoToolboxTileLane1EncodeInvocationMaxMilliseconds", "VT_TILE_LANE1_ENCODE_INVOCATION_MAX_MS"},
    {"videoToolboxTileLane1MetalStageAverageMilliseconds", "VT_TILE_LANE1_METAL_STAGE_AVG_MS"},
    {"videoToolboxTileLane1MetalStageMaxMilliseconds", "VT_TILE_LANE1_METAL_STAGE_MAX_MS"},
    {"videoToolboxTileLane1VTEncodeCallAverageMilliseconds", "VT_TILE_LANE1_ENCODE_CALL_AVG_MS"},
    {"videoToolboxTileLane1VTEncodeCallMaxMilliseconds", "VT_TILE_LANE1_ENCODE_CALL_MAX_MS"},
  };
