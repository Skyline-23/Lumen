...
void emitSelectedDiagnostics(const char *diagnostics) {
  ...
  static constexpr DiagnosticEmission emissions[] = {
    ...
    {"videoToolboxEncodeQueueWaitP50Milliseconds", "VT_ENCODE_QUEUE_WAIT_P50_MS"},
    {"videoToolboxEncodeQueueWaitP95Milliseconds", "VT_ENCODE_QUEUE_WAIT_P95_MS"},
    {"videoToolboxEncodeQueueWaitP99Milliseconds", "VT_ENCODE_QUEUE_WAIT_P99_MS"},
    ...
    {"videoToolboxEncodeInvocationP50Milliseconds", "VT_ENCODE_INVOCATION_P50_MS"},
    {"videoToolboxEncodeInvocationP95Milliseconds", "VT_ENCODE_INVOCATION_P95_MS"},
    {"videoToolboxEncodeInvocationP99Milliseconds", "VT_ENCODE_INVOCATION_P99_MS"},
    ...
    {"videoToolboxMetalStageP50Milliseconds", "VT_METAL_STAGE_P50_MS"},
    {"videoToolboxMetalStageP95Milliseconds", "VT_METAL_STAGE_P95_MS"},
    {"videoToolboxMetalStageP99Milliseconds", "VT_METAL_STAGE_P99_MS"},
    ...
    {"videoToolboxVTEncodeCallP50Milliseconds", "VT_ENCODE_CALL_P50_MS"},
    {"videoToolboxVTEncodeCallP95Milliseconds", "VT_ENCODE_CALL_P95_MS"},
    {"videoToolboxVTEncodeCallP99Milliseconds", "VT_ENCODE_CALL_P99_MS"},
    {"videoToolboxVTEncodeCallMaxMilliseconds", "VT_ENCODE_CALL_MAX_MS"},
    {"videoToolboxOutputCallbackLatencySampleCount", "VT_OUTPUT_CALLBACK_LATENCY_SAMPLE_COUNT"},
    {"videoToolboxOutputCallbackLatencyAverageMilliseconds", "VT_OUTPUT_CALLBACK_LATENCY_AVG_MS"},
    {"videoToolboxOutputCallbackLatencyP50Milliseconds", "VT_OUTPUT_CALLBACK_LATENCY_P50_MS"},
    {"videoToolboxOutputCallbackLatencyP95Milliseconds", "VT_OUTPUT_CALLBACK_LATENCY_P95_MS"},
    {"videoToolboxOutputCallbackLatencyP99Milliseconds", "VT_OUTPUT_CALLBACK_LATENCY_P99_MS"},
    {"videoToolboxOutputCallbackLatencyMaxMilliseconds", "VT_OUTPUT_CALLBACK_LATENCY_MAX_MS"},
  };
