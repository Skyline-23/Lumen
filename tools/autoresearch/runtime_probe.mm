...
void emitSelectedDiagnostics(const char *diagnostics) {
  ...
  static constexpr DiagnosticEmission emissions[] = {
    ...
    {"skyLightSourceCallbackCount", "SKYLIGHT_SOURCE_CALLBACK_COUNT"},
    {"skyLightSourceCallbackWithSurfaceCount", "SKYLIGHT_SOURCE_CALLBACK_WITH_SURFACE_COUNT"},
    {"skyLightSourceCallbackFrameCompleteCount", "SKYLIGHT_SOURCE_CALLBACK_FRAME_COMPLETE_COUNT"},
    {"skyLightSourceCallbackFrameIdleCount", "SKYLIGHT_SOURCE_CALLBACK_FRAME_IDLE_COUNT"},
    {"skyLightSourceCallbackDropStatusCount", "SKYLIGHT_SOURCE_CALLBACK_DROP_STATUS_COUNT"},
    {"skyLightSourceTimerTickCount", "SKYLIGHT_SOURCE_TIMER_TICK_COUNT"},
