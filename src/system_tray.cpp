...
// macros
    ...
    #define TRAY_ICON WEB_DIR "images/lumen.ico"
    #define TRAY_ICON_PLAYING WEB_DIR "images/lumen-playing.ico"
    #define TRAY_ICON_PAUSING WEB_DIR "images/lumen-pausing.ico"
    #define TRAY_ICON_LOCKED WEB_DIR "images/lumen-locked.ico"
  #elif defined(__linux__) || defined(linux) || defined(__linux)
    #define TRAY_ICON LUMEN_TRAY_PREFIX "-tray"
    #define TRAY_ICON_PLAYING LUMEN_TRAY_PREFIX "-playing"
    #define TRAY_ICON_PAUSING LUMEN_TRAY_PREFIX "-pausing"
    #define TRAY_ICON_LOCKED LUMEN_TRAY_PREFIX "-locked"
  #elif defined(__APPLE__) || defined(__MACH__)
    #define TRAY_ICON WEB_DIR "images/logo-lumen-16.png"
    #define TRAY_ICON_PLAYING WEB_DIR "images/lumen-playing-16.png"
    #define TRAY_ICON_PAUSING WEB_DIR "images/lumen-pausing-16.png"
    #define TRAY_ICON_LOCKED WEB_DIR "images/lumen-locked-16.png"
...
namespace system_tray {
  ...
  #ifdef _WIN32
    std::string tmp_str = "Open Lumen (" + config::shadow_http.host_name + ":" + std::to_string(net::map_port(shadow_control_http::PORT_HTTPS)) + ")";
    static const std::string title_str = utf8ToAcp(tmp_str);
  #else
    static const std::string title_str = "Open Lumen (" + config::shadow_http.host_name + ":" + std::to_string(net::map_port(shadow_control_http::PORT_HTTPS)) + ")";
  #endif
