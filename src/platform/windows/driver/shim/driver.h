...
struct LumenDeviceContext {
  ...
  LUID monitor_os_adapter_luid;
  UINT monitor_os_target_id;
...
EVT_IDD_CX_PARSE_MONITOR_DESCRIPTION2 LumenEvtIddCxParseMonitorDescription2;
EVT_IDD_CX_ADAPTER_QUERY_TARGET_INFO LumenEvtIddCxAdapterQueryTargetInfo;
...
EVT_IDD_CX_ADAPTER_COMMIT_MODES2 LumenEvtIddCxAdapterCommitModes2;
...
EVT_IDD_CX_MONITOR_QUERY_TARGET_MODES2 LumenEvtIddCxMonitorQueryTargetModes2;
