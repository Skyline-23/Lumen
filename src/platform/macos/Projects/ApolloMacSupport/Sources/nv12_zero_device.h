/**
 * @file src/platform/macos/Projects/ApolloMacPlatformRuntime/Sources/nv12_zero_device.h
...
namespace platf {
  ...
  public:
    ...
    using colorspace_fn_t = std::function<void(void *display, const video::stream_colorspace_t &)>;
