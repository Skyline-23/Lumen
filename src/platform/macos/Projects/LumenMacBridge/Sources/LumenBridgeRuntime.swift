...
public actor LumenBridgeRuntime {
    ...
    private nonisolated static func captureDiagnosticsSnippet(from statistics: MDKEncodedCaptureSessionStatistics?) -> String {
        ...
        let interestingPrefixes = [
            ...
            "skyLightSourceCallbackCount=",
            "skyLightSourceCallbackWithSurfaceCount=",
            "skyLightSourceCallbackFrameCompleteCount=",
            "skyLightSourceCallbackFrameIdleCount=",
            "skyLightSourceCallbackDropStatusCount=",
            "skyLightSourceTimerTickCount=",
